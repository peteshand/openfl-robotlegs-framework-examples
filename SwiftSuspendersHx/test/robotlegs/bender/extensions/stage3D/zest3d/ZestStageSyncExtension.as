...
package robotlegs.bender.extensions.stage3D.zest3d
{
	 ...
	 */
	public class ZestStageSyncExtension implements IExtension
	{
		...
		/** Extension UID. **/
		private const _uid:String = UID.create(ZestStageSyncExtension);
		...
		public function ZestStageSyncExtension() { }
		...
		{
			_logger.debug("Zest3D context views are now on stage. Initializing context...");
			_context.initialize();
		}
	}
}
