...
package robotlegs.bender.extensions.stage3D.alternativa3d
{
	 ...
	 */
	public class AlternativaStageSyncExtension implements IExtension
	{
		...
		/** Extension UID. **/
		private const _uid:String = UID.create(AlternativaStageSyncExtension);
		...
		public function AlternativaStageSyncExtension() { }
		...
		{
			trace("AlternativaStageSyncExtension");
			_context = context;
		...
		{
			_logger.debug("Alternativa3D context views are now on stage. Initializing context...");
			_context.initialize();
		}
	}
}
