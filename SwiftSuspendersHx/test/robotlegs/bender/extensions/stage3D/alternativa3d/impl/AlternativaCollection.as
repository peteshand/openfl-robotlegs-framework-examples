package robotlegs.bender.extensions.stage3D.alternativa3d.impl 
{
	 ...
	 * @author P.J.Shand
	 */
	public class AlternativaCollection extends BaseCollection
	{
		
		public function AlternativaCollection(alternativaCollectionData:Array=null) 
		{
			if (alternativaCollectionData){
				addItem(View3D(alternativaCollectionData[0]), String(alternativaCollectionData[1]));
			}
		}
