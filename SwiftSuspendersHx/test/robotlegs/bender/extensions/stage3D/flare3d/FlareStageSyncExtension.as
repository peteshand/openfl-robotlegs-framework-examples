...
package robotlegs.bender.extensions.stage3D.flare3d
{
	 ...
	 */
	public class FlareStageSyncExtension implements IExtension
	{
		...
		/** Extension UID. **/
		private const _uid:String = UID.create(FlareStageSyncExtension);
		...
		public function FlareStageSyncExtension() { }
		...
		{
			_logger.debug("Flare3D context views are now on stage. Initializing context...");
			_context.initialize();
		}
	}
}
