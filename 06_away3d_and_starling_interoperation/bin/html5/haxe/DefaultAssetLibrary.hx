...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("xml/config.xml", __ASSET__xml_config_xml);
		type.set ("xml/config.xml", AssetType.TEXT);
		className.set ("xml/_example_config.xml", __ASSET__xml__example_config_xml);
		type.set ("xml/_example_config.xml", AssetType.TEXT);
...
@:keep @:bind #if display private #end class __ASSET__img_atlas_xml extends null { }
...
@:keep @:bind #if display private #end class __ASSET__img_stars_pex extends null { }
...
@:keep @:bind #if display private #end class __ASSET__xml_config_xml extends null { }
@:keep @:bind #if display private #end class __ASSET__xml__example_config_xml extends null { }
...
@:file("assets/xml/_example_config.xml") #if display private #end class __ASSET__xml__example_config_xml extends lime.utils.ByteArray {}
